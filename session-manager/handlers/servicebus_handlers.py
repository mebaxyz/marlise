...
class ServiceBusHandlers:
    ...
    async def _call_bridge(self, method: str, **params):
        ...
        """
        try:
            return await self.bridge_client.call("modhost_bridge", method, **params)
    ...
    async def handle_load_plugin(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            instance_id = await self.plugin_manager.load_plugin(uri)
    ...
    async def handle_get_plugin_info(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            info = await self.plugin_manager.get_plugin_info(uri)
    ...
    async def handle_health_check(self, **_kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            plugin_status = await self.plugin_manager.health_check()

            # Check session manager
            session_status = await self.session_manager.health_check()
